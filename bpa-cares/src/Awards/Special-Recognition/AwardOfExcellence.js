              ...
              <div className="Wrapper">
                  ...
                  <div className="awardWrapper slideUp">
                      <div className="row">
                            ...
                            <h2>Purpose</h2>
                              <p>To recognize local chapters for their outstanding activities and program of work and to motivate
                              ...
                              <p> <a target="_blank" rel="noopener noreferrer" href ="https://docs.google.com/forms/d/e/1FAIpQLScI2Vu0jlYu-vCy_CLaQxzItdRNwum0cQWZEEYcYWv42kNTqA/viewform">Online Application</a></p>
                          ...
                          <div className="col-md-6">
                              ...
                              <Generalinfo/>
                              <ul>
                                  <li>Applicants may only count activities once in the BPA Cares Award Program, except Service Learning Individual and Chapter Activities Award of Excellence.</li>
                                  ...
                                  <li>It is not necessary for a chapter to attend the National Leadership Conference to participate in the program and receive the award.</li>
                      ...
                      <NonDiscrimination/>
                      <h2 className="no_style"><a target="_blank" rel="noopener noreferrer" className="no_style" href="http://www.bpa.org/service/rubriccaa">Chapter Activities Award Of Excellence Rubric</a></h2>
