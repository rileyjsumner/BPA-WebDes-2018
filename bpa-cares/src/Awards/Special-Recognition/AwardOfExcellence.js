  ...
  render() {
    return (
      ...
      <h1>Award Of Excellence</h1>
        <h2>Purpose</h2>
        <p>
        To recognize local chapters for their outstanding activities and program of work and to motivate
all local chapters to strive for an outstanding program of activities. </p>
<h2> Eligibility</h2>
<p>
All applicants must be in good standing with Business Professionals of America. This award is
open to members in the Middle Level, Post-Secondary and Secondary Divisions.
about the nominee: </p>
...
earn the award, but must complete a qualified activity in the award category):
BPA Marketing & Public Relations Award (minimum one (1) activity)
Community Service Award (minimum one (1) activity, with articles totaling 100 hours and/or
$500.00 donated dollars)</p>
<p>Activity descriptions for at least ONE of the following awards (applicant is not required to
earn the award, but must complete a qualified activity in the award category)
Special Olympics (minimum one (1) activity)
Safety Awareness (minimum one (1) activity)
Environmental Action/Awareness (minimum one (1) activity)</p>
<ul>An activity description relating to EACH of the following activities:
<li>Local officer installation</li>
<li/>Local officer training</li>
<li>A BPA Leadership Conference attended by your chapter (regional, state or national)</li>
<li>Chapter social activity</li>
<li>Local chapter budget</li>
...
<li>All activity descriptions must include title, project details, date project completed, location of the
project and description of the project.</li>
<li>NO E-MAIL OR MAIL APPLICATIONS WILL BE ACCEPTED.</li>
<li>All materials submitted become the property of Business Professionals of America and may be
used as the National Center deems appropriate.</li>
<li>It is not necessary for a chapter to attend the National Leadership Conference to participate in the
program and receive the award.</li>
<li>DO NOT SEND ANY AWARD APPLICATION(S) AS PART OF ANOTHER APPLICATION.
...
quote
(4 points for each
item, up to 20 total) </th>
    <th>Article is written with
complete sentences,
good spelling and
grammar, and proper
capitalization
...
<tr>
<td> Local officer training article
 </td>
<td> </td>
<td> </td>
<td> </td>
...
<tr>
<td> Local chapter budget article
 </td>
<td> </td>
<td> </td>
<td> </td>
...
<tr>
<td> Career development activity
article
 </td>
<td> </td>
<td> </td>
...
=======
    render() {
        ...
        <div className="awardWrapper">
            ...
            <p>Activities completed between April 2, 2017 and April 1, 2018 (11:59 PM EST) can be counted
            towards this award.</p>
            <a href="http://www.bpa.org/service/rubriccaa"></a>
            <h2>Required Activities</h2>
            <h3>Activities for this award can be duplicated from other activity submissions.</h3>
            <p> The following award applications are required to be submitted (applicant is not required to
            earn the award, but must complete a qualified activity in the award category):
            ...
            <ul>An activity description relating to EACH of the following activities:
                ...
                <li>Local chapter budget</li>
                <li>A career development related activity for the chapter (could include seeing a speaker, watching a
                film, taking a field trip, etc.)</li>
            </ul>
            <Generalinfo/>
            <ul>
                <li>Applicants may only count activities once in the BPA Cares Award Program, except Service
                Learning Individual and Chapter Activities Award of Excellence.</li>
                <li>Chapters may complete more than one activity to equal the total number of hours/dollars.</li>
                <li>Activity descriptions cannot exceed 500 words in total.</li>
                <li>All activity descriptions must include title, project details, date project completed, location of the
                ...
                <li>DO NOT SEND ANY AWARD APPLICATION(S) AS PART OF ANOTHER APPLICATION.
                AWARDS MAY NOT BE SUBMITTED WITH TECHNICAL PROJECTS FOR COMPETITIVE
                EVENTS. EACH AWARD MUST BE SUBMITTED SEPARATELY.</li>
            </ul>
            <h2>Recognition</h2>
...
>>>>>>> c4b89a572c7a215667a7db008042681cb0ee5f0d
}
