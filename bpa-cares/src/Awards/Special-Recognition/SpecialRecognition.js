...
export class SpecialRecognition extends Component {
    render() {
        return (
                ...
                <div className="awardWrapper slideUp">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p>BPA Marketing and Public Relations, Chapter Activities Award of Excellence, Social Media and The Professional Cup: Activities completed between April 2, 2017 and April 1, 2018 (11:59 PM EST) can be counted towards these awards</p>
                            <p>Recruiter of the Year and Membership Explosion Award: Activities completed between August 31, 2017 and February 15, 2018 (11:59 PM EST) can be counted toward these awards.</p>
                            ...
                            <h2>Purpose</h2>
                            <p>The purpose of the Special Recognition Awards Program is to encourage individuals and chapters to support and promote their organizations</p>
