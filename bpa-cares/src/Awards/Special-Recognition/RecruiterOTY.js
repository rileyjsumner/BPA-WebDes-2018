                ...
                <div className="awardWrapper slideUp">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p><a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSdbPT1vwJ3AokRh60YJ3j379ow1YxY39w0o0sMLNNrn2xYhhA/viewform"> Online Application </a></p>
                        </div>
                        <div className="col-md-6">
                        <h2>Purpose</h2>
