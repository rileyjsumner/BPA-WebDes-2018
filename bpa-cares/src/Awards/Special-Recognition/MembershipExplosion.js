                ...
                <div className="awardWrapper slideup">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <h2>Purpose</h2>
                            <p>To recognize outstanding chapters who have successfully recruited members to their chapters adding to the overall strength and size of our organization.</p>
                            <h2>Eligibility</h2>
                            <p>All applicants must be in good standing with Business Professionals of America. This award is open to members of the Middle Level, Post-Secondary and Secondary Divisions. Applicants must have at least 15 registered members in good standing during the previous membership year and experience a minimum of 30% increase from their previous year.</p>
                            <p>An application is not required for this award. The award will be given by the National Center to those chapters meeting the criteria.</p>
