                ...
                <div className="awardWrapper slideUp">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p> Having trouble with the BPA Cares Awards? Visit our<a target="_blank" href="http://www.bpa.org/service/caresfaq">Frequently Asked Questions Page.</a></p>
                        </div>
                        <div className="col-md-6">
                            <h2> Eligibility</h2>
                            ...
                            <p> The test will be developed annually by the National Center. Resources used will be the BPA Cares Handbook, the Torch Awards Handbook, and <a target="_blank" href="www.bpa.org">www.bpa.org.</a></p>
