...
export class NonDiscrimination extends Component {
  render() {
    return (
      <div className="generalContent">
        ...
        <p> It is the policy of business Professionals of America that no person on the basis
         ...
         deined the benefits of, or otherwise be subjected to, discrimination in any program or activity for which it is responsible.
         <p/>
      </div>
    )
  }
